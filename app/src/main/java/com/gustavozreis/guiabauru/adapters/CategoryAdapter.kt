...
class CategoryAdapter(
    ...
    private var estabelecimentoList: List<Estabelecimento> = EstabelecimentosData.estabelecimentosList
    ...
    override fun onBindViewHolder(holder: CategoryAdapter.CategoryViewHolder, position: Int) {
        ...
        holder.cardView.setOnClickListener {
            holder.cardView.findNavController().navigate(R.id.action_categoryFragment_to_estabelecimentosFragment)
        }
    }
